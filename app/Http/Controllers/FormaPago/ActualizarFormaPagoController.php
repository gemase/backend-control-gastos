...
use App\UseCases\FormaPago\ActualizarFormaPagoUseCase;
use Illuminate\Http\Response;

class ActualizarFormaPagoController extends Controller
{
    public function __construct(
        private readonly ActualizarFormaPagoUseCase $useCase
    ) {}

    public function __invoke(EditarFormaPagoRequest $request, int $id)
    {
        try {
